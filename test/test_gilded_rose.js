...
describe("Gilded Rose", function () {
  ...
  it(`If the is not Aged Brie, Backstage passes or Sulfuras, Hand of Ragnaros, and has a quality value of 0, 
  ...
  it(`If the item is not Aged Brie, Backstage passes or Sulfuras, Hand of Ragnaros, 
      and has a quality value above zero, and a sellIn-value of 0, 
  ...
  it(`If the item is not Aged Brie, Backstage passes or
      Sulfuras, Hand of Ragnaros, and has a quality value above 1 and a sellin value under 1, 
  ...
  it(`If the item is not Aged Brie, Backstage passes or Sulfuras, Hand of Ragnaros, 
      and has a quality value above 1 and a selling value above zero, 
      update quality will lower quality by one.`, function () {
  ...
  it(`If the item is Backstage passes and has a quality value less than 50, 
      and a sellIn of 0, update quality will reduce quality value to zero`, function () {
  ...
  it(`If the item is Backstage passes and has a quality value less than 50, 
      but a sellin value above 0, update quality will add 3 to quality value`, function () {
  ...
  it(`If the item is Backstage passes and has a quality value less than 50, 
      but a sellin value of above 5, update quality will add 2 to quality value`, function () {
  ...
  it(`If the item is Backstage passes and has a quality value less than 50, 
      but a sellin value of above 10, update quality will add 1 to quality value`, function () {
    const gildedRose = new Shop([new Item("Backstage passes to a TAFKAL80ETC concert", 11, 0)]);
    const items = gildedRose.updateQuality();
    expect(items[0].quality).to.equal(1);
  });

  it(`If the item is Backstage passes and has a quality value of 50 or more, and a sellin value of 0,
  ...
  it(`If the item is Backstage passes and has a quality value under 50, and a sellin value between 0 and 6,
  ...
  it(`If the nitem is Backstage passes and has a quality value of 49, and a sellin value between 0 and 6,
      update quality will add value only up to 50`, function () {
    const gildedRose = new Shop([new Item("Backstage passes to a TAFKAL80ETC concert", 1, 49)]);
    const items = gildedRose.updateQuality();
    expect(items[0].quality).to.equal(50);
  });

  it(`If the item is Backstage passes and has a quality value of 50 or more,
      update quality will not change the quality value`, function () {
